...
if /i "%1"=="update" (
    echo openclaw is managed by MyClawX ^(bundled version^).
    echo.
    echo To update openclaw, update MyClawX:
    echo   Open MyClawX ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=MyClawX
"%~dp0..\..\MyClawX.exe" "%~dp0..\openclaw\openclaw.mjs" %*
